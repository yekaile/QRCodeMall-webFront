    ...
    <div style="width: 450px;border: 1px solid #409EFF;border-radius: 30px;margin: 20px auto;padding: 30px">
        <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm"
            ...
            <el-form-item prop="userPassword">
                <el-input show-password placeholder="密码" prop="userPassword" v-model="ruleForm.userPassword"></el-input>
            </el-form-item>
            <el-form-item prop="userFatherProxyName">
                <el-input placeholder="请输入推荐你的人的用户名(选填)" v-model="ruleForm.userFatherProxyName"></el-input>
            </el-form-item>
